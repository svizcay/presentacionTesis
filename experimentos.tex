...
\begin{columns}
  \begin{column}{.50\textwidth}
	\centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_openmp_double}}
      %\pgfimage[height=3.5cm]{pics/house}}

  \end{column}
  \begin{column}{.50\textwidth}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_openmp_float}}
      %\pgfimage[height=3.5cm]{pics/house}}
  \end{column}
  \end{columns}
\end{block}
...
\begin{columns}
  \begin{column}{.50\textwidth}
	\centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_openmp_double_speedup}}
      %\pgfimage[height=3.5cm]{pics/house}}

  \end{column}
  \begin{column}{.50\textwidth}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_openmp_float_speedup}}
      %\pgfimage[height=3.5cm]{pics/house}}
  \end{column}
  \end{columns}
\end{block}
...
\begin{columns}
  \begin{column}{.50\textwidth}
	\centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/titan_openmp_double}}
      %\pgfimage[height=3.5cm]{pics/house}}

  \end{column}
  \begin{column}{.50\textwidth}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/titan_openmp_float}}
      %\pgfimage[height=3.5cm]{pics/house}}
  \end{column}
  \end{columns}
\end{block}
...
\begin{columns}
  \begin{column}{.50\textwidth}
	\centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/titan_openmp_double_speedup}}
      %\pgfimage[height=3.5cm]{pics/house}}

  \end{column}
  \begin{column}{.50\textwidth}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/titan_openmp_float_speedup}}
      %\pgfimage[height=3.5cm]{pics/house}}
  \end{column}
  \end{columns}
\end{block}
...
\begin{block}{Tiempos de transferencia: CUDA y OpenCL}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/titan_gpu_transfer}}
      %\pgfimage[height=3.5cm]{pics/house}}
\end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}
  \begin{column}{.50\textwidth}
	\centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_simd_double}}
  \end{column}
  \begin{column}{.50\textwidth}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_simd_float}}
  \end{column}
\end{columns}
\end{block}
\end{frame}
...
\begin{columns}
  \begin{column}{.50\textwidth}
	\centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_simd_double_speedup}}
      %\pgfimage[height=3.5cm]{pics/house}}

  \end{column}
  \begin{column}{.50\textwidth}
    \centerline{
      \pgfimage[height=4.5cm]{pics/graficosEs/nanoserver_simd_float_speedup}}
      %\pgfimage[height=3.5cm]{pics/house}}
  \end{column}
  \end{columns}
\end{block}
